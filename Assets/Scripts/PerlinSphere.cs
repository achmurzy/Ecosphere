...
class PerlinSphere : MonoBehaviour
{
    ...
    void Awake()
    {
        Vector2 initialPerlin = Random.insideUnitCircle * Random.RandomRange(0, 1000f);
    }
    ...
    public Mesh MakeCloud()
    {
        ...
        //Vector2 pc1 = Random.insideUnitCircle * Random.RandomRange(0, 1000f);
        Vector2 pc1 = initialPerlin + (Vector2.one * PerlinShift);
        initialPerlin = pc1;
